...
public class WebSocketHandler extends SimpleChannelInboundHandler<Object> {
	...
	private void handlerHttpRequest(ChannelHandlerContext ctx,FullHttpRequest req){
		...
		WebSocketServerHandshakerFactory wsFactory = new WebSocketServerHandshakerFactory
				("ws://localhost:8008/websocket", null, false);
	...
	private void handleWebSocketFrame(ChannelHandlerContext ctx,WebSocketFrame frame){
		...
		if(!(frame instanceof TextWebSocketFrame)){
			throw new UnsupportedOperationException(String.format("%s frame types not support",
	...
	private static void sendHttpResponse(ChannelHandlerContext ctx,FullHttpRequest req,FullHttpResponse
			resp){
		//返回应答给客户端
